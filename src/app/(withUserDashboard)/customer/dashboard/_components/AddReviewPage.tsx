        ...
        <div className="bg-white rounded-2xl p-4 flex items-center justify-between mb-8 text-left border border-gray-100">
          <div className="flex gap-4">
            <div className="w-16 h-16 bg-gray-200 rounded-lg overflow-hidden">
              <Image
                src="https://images.unsplash.com/photo-1512690196252-788865463777?q=80&w=200"
                alt="Spa"
              />
            </div>
            <div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2 text-left">
            ...
            <textarea
              ...
              className="w-full h-32 p-4 rounded-2xl border-none focus:ring-2 focus:ring-red-100 outline-none text-sm"
            />
          </div>
