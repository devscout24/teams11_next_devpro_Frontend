        ...
        <div className="flex items-center justify-between px-4 py-3 border-b">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-foreground min-w-[80px] text-center">April 2026</h2>
              <Button variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground">
                <ChevronRight className="h-4 w-4" />
              </Button>
            </div>
            <Button variant="secondary" size="sm" className="h-8 px-4 text-xs font-medium bg-muted/50">
              Today
            </Button>
          </div>
          ...
          <AppointmentModal 
            trigger={
              <Button size="icon" className="h-8 w-8 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground shadow-sm">
